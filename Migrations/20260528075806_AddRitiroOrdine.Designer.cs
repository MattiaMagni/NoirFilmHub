...
namespace FilmAPI.Migrations
{
    ...
    [Migration("20260528075806_AddRitiroOrdine")]
    partial class AddRitiroOrdine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmAPI.Model.RitiroOrdine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CodiceRitiro")
                        .IsRequired()
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<int?>("RitiratoDaUtenteId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("RitiratoIl")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("CodiceRitiro")
                        .IsUnique();

                    b.HasIndex("RitiratoDaUtenteId");

                    b.ToTable("RitiriOrdine");
                });
            ...
            modelBuilder.Entity("FilmAPI.Model.RitiroOrdine", b =>
                {
                    ...
                    b.HasOne("FilmAPI.Model.Utente", "RitiratoDaUtente")
                        .WithMany()
                        .HasForeignKey("RitiratoDaUtenteId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Cart");

                    b.Navigation("RitiratoDaUtente");
                });
